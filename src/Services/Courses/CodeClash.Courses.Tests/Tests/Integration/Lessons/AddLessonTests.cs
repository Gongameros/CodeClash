...
public sealed class AddLessonTests(IntegrationFixture fixture) : IAsyncLifetime
{
    ...
    public async Task Handle_WrongAuthor_ReturnsModuleNotFound()
    {
        ...
        var result = await fixture.Mediator.Send(new AddLessonCommand(
            ...
            "Lesson", LessonType.Theory, 0, null, null));
    ...
    public async Task Handle_MultipleLessons_AppendsAll()
    {
        ...
        await fixture.Mediator.Send(LessonFactory.CreateCommand(courseId, moduleId, title: "Lesson 1", order: 0));
        await fixture.Mediator.Send(LessonFactory.CreateCommand(courseId, moduleId, title: "Lesson 2", type: LessonType.Quiz, order: 1));
